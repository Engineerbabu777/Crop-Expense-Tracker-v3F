...
export default function Update({closeButton,prevData}:Props){
    ...
    <p className="text-start mb-1">Enter Bags:</p>
    <input type="number" name="units" value={data?.bags} onChange={handler}className="w-full p-2 outline-none border-2 border-green-500 rounded-md" placeholder="Enter Updated Units"/>
