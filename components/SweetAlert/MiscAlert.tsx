...
function Alert({closeButton,misc,setMisc,m}:Props){
...
<div className="flex gap-4 justify-center items-center mt-12">
    ...
    <button  className="text-red-300 bg-red-700 opacity-[0.9] p-2 rounded-md" onClick={() => deleteEntry(m._id)}>Delete</button>
